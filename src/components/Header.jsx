  ...
  return (
    ...
    <section className='h-[90vh] flex justify-center items-center'>
      ...
      {/* header */}
        ...
        {/* header content */}
        <section class="items-center justify-center bg-white">
        <div class="text-center md:flex md:text-left md:items-center justify-center">
            ...
            <div class="md:w-1/2">
                ...
                <p class="my-4">Profissional de TI especializado em Análise <br/> e Desenvolvimento de Software.</p>
                <div className='mt-2'>
                  <Button href='#contact' className='main-button' variant="contained" endIcon={<SendIcon />}>Contate-me</Button>
                </div>
            </div>
